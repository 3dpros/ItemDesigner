            ...
            ! function(n, a) {
                ...
                var Be = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
                    ...
                    Pn = function() {
                        function t(e) {
                            var n = this;
                            Le(this, t), Object.keys(this.deprecatedProperties).forEach(function(t) {
                                ...
                                n[t] = e[t]
                            }), e.hasOwnProperty("apiVersion") ? this.apiVersion = e.apiVersion : this.apiVersion = "2020-07", e.hasOwnProperty("source") && (this.source = e.source), e.hasOwnProperty("language") && (this.language = e.language)
                        }
                        return je(t, [{
                    ...
                    Ri = function() {
                        ...
                        return n.load = function() {
                            ...
                            return new Promise(function(e) {
                                t.onload = function() {
                                    e()
                                }, t.src = ji, document.head.appendChild(t), setTimeout(function() {
                                    e()
                                }, 500)
                            })
                                        ...
                                        d = r.reduce(function(e, n) {
                                            ...
                                            if (Po.indexOf(a) > -1) {
                                                ...
                                                e.totalDiscount += i, e.discounts.push({
                                                    discount: "".concat(o, " (-").concat(se(i, t.moneyFormat), ")")
                                                })
                                            }
                                            return e
                                        }, {
                ...
                if (Mo.arrayBuffer) var Bo = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"],
                    Lo = ArrayBuffer.isView || function(t) {
                ...
                var $d = {
                    ...
                    oc = function() {
                        var t, e = nr("iframe"),
                            ...
                            o = ">",
                            r = "java" + i + ":";
                        for (e.style.display = "none", ec.appendChild(e), e.src = String(r), t = e.contentWindow.document,
                            t.open(), t.write(a + i + o + "document.F=Object" + a + "/" + i + o), t.close(), oc = t.F; n--;) delete oc[ac][Fd[n]];
                        return oc()
                    },
